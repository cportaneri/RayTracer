...
# Groningen by Tobias Isenberg. Cedric Portaneri, Toavina Rakotomanga
############################################################################
...
OBJS = main.o raytracer.o sphere.o light.o material.o \
	image.o triple.o lodepng.o scene.o box.o plane.o triangle.o camera.o quad.o cylinder.o glm.o mesh.o
